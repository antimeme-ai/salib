# TCK — alternative estimator alternative first-order Sobol' estimators
...
first-order), Owen 2013 Correlation 2. of
(first alternative estimator PR after
SALib parity).
...
- ADR.
- alternative estimator plan-of-record.
