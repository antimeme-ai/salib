# Alternative first-order estimators — Janon 2014 + Jansen 1999 alt + Owen 2013 first-
...
Feature: Alternative first-order estimators — alternative first-order Sobol' estimators
