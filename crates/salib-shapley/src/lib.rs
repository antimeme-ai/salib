...
//!
//! Currently independent-input Shapley only. `c(J)`'s outer step
...
//!
//! Dependent-input Shapley is planned for a future release.
//!
//! # Determinism
//!
...
//! # Crate boundaries
//!
//! Depends on `salib-core` (`Distribution`, `RngState`, `tree_sum`/`tree_var`).
