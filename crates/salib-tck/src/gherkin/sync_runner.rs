...
//! async salib surface) cannot use `SyncRunner` as-is.
//!
...
//! regex, no parameter extraction à la cucumber-rs. Rationale: salib
...
//!
//! If salib TCK grows toward regex-parameterized steps, that's the
