...
impl fmt::Display for AnovaTwoWayResult {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(
            ...
            self.v_column,
            self.ms_column,
            fmt_opt(self.f_column),
            fmt_opt(self.p_column)
        )?;
        writeln!(
            f,
            "  {:>14}  {:>10.4}  {:>10.4}  {}  {}",
            ...
            self.v_interaction,
            self.ms_interaction,
            fmt_opt(self.f_interaction),
            fmt_opt(self.p_interaction)
        )?;
        writeln!(
            f,
            "  {:>14}  {:>10.4}  {:>10.4}",
            "Residual", self.v_residual, self.ms_residual
        )?;
        Ok(())
    }
}
...
impl fmt::Display for AnovaThreeWayResult {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(
            ...
            self.v_brittleness,
            self.ms_brittleness,
            fmt_opt(self.f_brittleness),
            fmt_opt(self.p_brittleness)
        )?;
        writeln!(
            f,
            "  {:>20}  {:>10.4}  {:>10.4}  {}  {}",
            ...
            self.v_inference,
            self.ms_inference,
            fmt_opt(self.f_inference),
            fmt_opt(self.p_inference)
        )?;
        writeln!(
            f,
            "  {:>20}  {:>10.4}  {:>10.4}  {}  {}",
            "Data*Brittleness",
            self.v_data_brittleness,
            self.ms_data_brittleness,
            fmt_opt(self.f_data_brittleness),
            fmt_opt(self.p_data_brittleness)
        )?;
        writeln!(
            f,
            "  {:>20}  {:>10.4}  {:>10.4}  {}  {}",
            "Data*Inference",
            self.v_data_inference,
            self.ms_data_inference,
            fmt_opt(self.f_data_inference),
            fmt_opt(self.p_data_inference)
        )?;
        writeln!(
            f,
            "  {:>20}  {:>10.4}  {:>10.4}  {}  {}",
            "Britt*Inference",
            self.v_brittleness_inference,
            self.ms_brittleness_inference,
            fmt_opt(self.f_brittleness_inference),
            fmt_opt(self.p_brittleness_inference)
        )?;
        writeln!(
            f,
            "  {:>20}  {:>10.4}  {:>10.4}  {}  {}",
            "D*B*I",
            self.v_data_brittleness_inference,
            self.ms_data_brittleness_inference,
            fmt_opt(self.f_data_brittleness_inference),
            fmt_opt(self.p_data_brittleness_inference)
        )?;
        writeln!(
            f,
            "  {:>20}  {:>10.4}  {:>10.4}",
